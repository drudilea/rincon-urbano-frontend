  ...
  return (
    <div style={{ color: 'white' }}>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Rincon
        Urbano.
      </p>
      <p>
        Rincon Urbano is committed to ensuring that the app is as useful and
      ...
      <p>
        The Rincon Urbano app stores and processes personal data that you have
        ...
        phone’s security features and it could mean that the Rincon Urbano app
      ...
      <p>
        You should be aware that there are certain things that Rincon Urbano
        ...
        can be Wi-Fi, or provided by your mobile network provider, but Rincon
        Urbano cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Rincon Urbano cannot always take responsibility
        ...
        avail the Service, Rincon Urbano cannot accept responsibility.
      </p>
      <p>
        With respect to Rincon Urbano’s responsibility for your use of the app,
        ...
        make it available to you. Rincon Urbano accepts no liability for any
      ...
      <p>
        ...
        to keep using the app. Rincon Urbano does not promise that it will
      ...
      <p>These terms and conditions are effective as of 2020-06-03</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at rinconurbanoclub@gmail.com.
      </p>
    </div>
  );
};
